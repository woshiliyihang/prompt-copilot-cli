...
def parser() -> argparse.ArgumentParser:
    ...
    p.add_argument("--version", action="version", version="prompt-copilot 0.4.0")
    return p
...
def run_interactive(runtime: AgentRuntime) -> None:
    ...
    session = PromptSession(
        ...
        bottom_toolbar="Enter: newline   Ctrl+Enter: send   /exit: quit   /clear: reset conversation   /memory: show memory",
    )
